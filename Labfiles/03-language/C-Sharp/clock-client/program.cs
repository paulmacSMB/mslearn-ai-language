            ...
            try
            {
                ...
                while (userText.ToLower() != "quit")
                {
                    ...
                    if (userText.ToLower() != "quit")
                    {
                        ...
                        dynamic conversationTaskResult = response.Content.ToDynamicFromJson(JsonPropertyNames.CamelCase);
                        dynamic conversationPrediction = conversationTaskResult.Result.Prediction;
                        var options = new JsonSerializerOptions { WriteIndented = true };
                        Console.WriteLine(JsonSerializer.Serialize(conversationTaskResult, options));
                        Console.WriteLine("--------------------\n");
